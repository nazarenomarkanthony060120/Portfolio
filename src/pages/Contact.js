...
function Contact() {
    return (
        <div className="flex items-center justify-center bg-[#123] h-screen max-sm:px-10">
            <div className="mx-auto max-w-7xl text-white h-fit max-xl:h-fit max-md:grid-cols-1 gap-14">
                <div className="flex items-center justify-center flex-col gap-4">
                    <div className="flex flex-col w-fit gap-5  bg-white text-black rounded-lg max-sm:p-5 p-10">
                        ...
                        <div className="flex border-2 border-gray-500 flex-wrap gap-2 rounded-lg px-3">
                            ...
                            <textarea name="message" placeholder='Message' className='py-2 focus:outline-none' id="message" cols="30" rows="10"></textarea>
                        </div>
                        <div className="text-center">
