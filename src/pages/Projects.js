                    ...
                    <div className="flex justify-evenly flex-wrap gap-14 max-xl:justify-evenly py-5">
                        ...
                        <AnimateGroup play>
                            <Animate start={{ opacity: 0 }} end={{ opacity: 1 }} sequenceIndex={0}>
                                <div className="relative h-fit w-[350px] bg-white text-black rounded-xl transition-transform transform hover:scale-110">
                            ...
                            <Animate start={{ opacity: 0 }} end={{ opacity: 1 }} sequenceIndex={1}>
                                <div className="relative h-fit w-[350px] bg-white text-black rounded-xl transition-transform transform hover:scale-110">
                                    ...
                                    <div className="relative rounded-lg bg-white">
                                        <div className="text-center flex flex-col gap-3">
                                            <img src={AdminWebsite} className='rounded-tl-lg rounded-tr-lg' alt="Admin Website" />
                            ...
                            <Animate start={{ opacity: 0 }} end={{ opacity: 1 }} sequenceIndex={2}>
                                <div className="relative h-fit w-[350px] bg-white text-black rounded-xl transition-transform transform hover:scale-110">
                                    ...
                                    <div className="relative rounded-lg bg-white">
                                        <div className="text-center flex flex-col gap-3">
                                            <img src={TeacherWebsite} className='rounded-tl-lg rounded-tr-lg' alt="Teacher Website" />
                            ...
                            <Animate start={{ opacity: 0 }} end={{ opacity: 1 }} sequenceIndex={3}>
                                <div className="relative h-fit w-[350px] bg-white text-black rounded-xl transition-transform transform hover:scale-110">
                                    ...
                                    <div className="relative rounded-lg bg-white">
                                        <div className="text-center flex flex-col gap-3">
                                            <img src={ParentWebsite} className='rounded-tl-lg rounded-tr-lg' alt="Parent Website" />
